                            ...
                            <div class="col-md-2 col-sm-12 col-xs-12">
                                    <div class="card-box text-center">
                                            ...
                                            <?php if($this->image_model->isApproved($image->ID)){
                                                $class="text-success";
                                                $message = "This bottle has been Authorized to use.";
                                            }
                                            else{
                                                $class="text-danger";
                                                $message = "This bottle has not been Authorized to use.";
                                            }
                                            ?>


                                            <img src="<?php echo base_url().'uploads/'.$filename;?>" class="img-fluid" data-toggle="tooltip" data-placement="top" title="<?php echo $message;?>" data-original-title="<?php echo $message;?>">
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                             ...
                             <div class="col-md-4 col-sm-12 col-xs-12">
                                    ...
                                    <div class="card-box">
                                            ...
                                            <?php if($authorization->status=='authorized_by_customer'):?>
                                            ...
                                            <?php elseif($authorization->status=='not_authorized_by_customer'):?>
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12">
                                        ...
                                        <div class="card-box">
                                                ...
                                                <?php if($confidential->internal_event_presentations==1):?>
                                                ...
                                                <?php if($confidential->external_event_and_expo_presentations	==1):?>
                                                ...
                                                <?php if($confidential->capability_center_specific	==1):?>
                                                ...
                                                <?php if($confidential->dmm_section_specific	==1):?>
                                                ...
                                                <?php if($confidential->summer_meeting_specific	==1):?>
                                                ...
                                                <?php if($confidential->ctm_meeting_specific==1):?>
                                                ...
                                                <?php if($confidential->other_meetings==1):?>

                                                    <div class="checkbox checkbox-primary"><i class="fa fa-check-square-o green"></i>  Other Meetings: <?php echo $confidential->other_meetings_info;?></div>
                                ...
                                <div class="col-md-4 col-sm-12 col-xs-12">
                                        ...
                                        <div class="card-box">
                                                ...
                                                <?php if($non_confidential->internal_event_presentations==1):?>
                                                ...
                                                <?php if($non_confidential->external_event_and_expo_presentations	==1):?>
                                                ...
                                                <?php if($non_confidential->capability_center_specific	==1):?>
                                                ...
                                                <?php if($non_confidential->dmm_section_specific	==1):?>
                                                ...
                                                <?php if($non_confidential->summer_meeting_specific	==1):?>
                                                ...
                                                <?php if($non_confidential->ctm_meeting_specific==1):?>
                                                ...
                                                <?php if($non_confidential->other_meetings==1):?>

                                                    <div class="checkbox checkbox-primary"><i class="fa fa-check-square-o green"></i>  Other Meetings: <?php echo $non_confidential->other_meetings_info;?></div>
