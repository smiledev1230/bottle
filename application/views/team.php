                        ...
                        <div class="row m-b-20">
                        	...
                        	<div class="col-sm-12">
                                ...
                                <div class="card-box tilebox-one">
                                    ...
                                    <strong>Bottle Tracker Administrative Team</strong><br><br>

                                    <p>Welcome to the Bottle Tracker Administrative Team. This group is responsible for the approval or disapproval of bottles displayed across different mediums. Administrators must contact customers, work with their team and/or simply specify if the bottles are approved for use in collateral marketing materials for internal or external presentations or events.<br><br>
                                ...
                                <p class="m-t-20">
                                    ...
                                    <div class="card-box tilebox-one">
                                        ...
                                        Administrators can upload an image temporarily to the site, fill out the information required, and submit the bottle for approval to the team. This means the image will be just be a preview until the Marketing and Communications Department approves the image based on quality and formatting. This way all users will have the best quality of the image possible for their presentations.
                            ...
                            <div class="row m-b-20">
                                ...
                                <div class="col-sm-12">
                                    ...
                                    <h3 align="center">Administrative Team</h3>
