...
<head>
    ...
    <title>Plastipak Bottle Tracker</title>
    ...
    <link href="<?php echo base_url();?>assets/plugins/responsive-table/css/rwd-table.min.css" rel="stylesheet" type="text/css" media="screen">
